...
def main(): 
    ...
    parser.add_argument("--N", help="Number of qubits", required=False, type=int, default=30)
    ...
    parser.add_argument("--ansatz_type", help="type of ansatz, qaoa or 'parallel_cz and so on'", required=False, type=str, default='qaoa')
